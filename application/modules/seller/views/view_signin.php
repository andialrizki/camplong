  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-sm-6">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title text-success text-center">Masuk Akun Penjual</h5>
            <hr>
            <?php echo showAlert($alert) ?>
            <p>Apakah Anda belum memiliki Akun? <a href="<?php echo site_url('seller/register') ?>">Daftar disini</a></p>
            <form action="<?php echo site_url('seller/signin/submit') ?>" method="post" autocomplete="off">
