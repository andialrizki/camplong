          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <a href="<?php echo site_url('webmin/user/customer') ?>" class="btn btn-xs btn-info"><i class="fa fa-arrow-circle-right"></i> Selengkapnya</a>
                </div>
                <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo $seller ?></span>
                  <a href="<?php echo site_url('webmin/user/seller') ?>" class="btn btn-xs btn-info"><i class="fa fa-arrow-circle-right"></i> Selengkapnya</a>
                </div>
                <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo $prod_active ?></span>
                  <a href="<?php echo site_url('webmin/product/show') ?>" class="btn btn-xs btn-info"><i class="fa fa-arrow-circle-right"></i> Selengkapnya</a>
                </div>
                <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Produk Tidak Aktif</span>
                  <span class="info-box-number"><?php echo $prod_nonactive ?></span>
                  <a href="<?php echo site_url('webmin/product/show') ?>" class="btn btn-xs btn-info"><i class="fa fa-arrow-circle-right"></i> Selengkapnya</a>
                </div>
                <!-- /.info-box-content -->
              </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo $failed ?></span>
